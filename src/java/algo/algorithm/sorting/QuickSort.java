...
public class QuickSort {
    ...
    /**
     * Worst-case performance	O(n^2) Best-case performance	O(n log n) Average performance	O(n log n) Worst-case space
     * complexity	O(n) auxiliary (naive) O(log n) auxiliary
     */
