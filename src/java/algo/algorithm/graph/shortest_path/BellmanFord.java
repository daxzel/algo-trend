...
public class BellmanFord {
     ...
     * other vertices in a weighted digraph.[1] It is slower than Dijkstra's algorithm for the same problem, but more
     ...
     * Ford, Jr., who published it in 1958 and 1956, respectively. Edward F. Moore also published the same algorithm in
     * 1957, and for this reason it is also sometimes called the Bellman–Ford–Moore algorithm.
     * <p>
     * Negative edge weights are found in various applications of graphs, hence the usefulness of this algorithm. If a
     ...
     * one more walk around the negative cycle. In such a case, the Bellman–Ford algorithm can detect negative cycles
     * and report their existence.
     * <p>
     * Worst-case performance	     Theta (V * E) Best-case performance	     Theta (E) Worst-case space complexity	 Theta
     * (V)
     */
